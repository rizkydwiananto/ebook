<div class="row">
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            <img class="profile-user-img img-responsive img-circle" src="<?=base_url()?>assets/images/foto/user.png" alt="User profile picture">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <strong><i class="fa fa-id-badge margin-r-5"></i> Unit</strong>

                <p class="text-muted"><?php echo $this->session->userdata("unit"); ?></p>
            </div>
            <!-- /.box-body -->
        </div>
        <!-- /.box -->
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="active tab-pane" id="peraturan">
                        ...
                        <hr>
                        <img src="<?=base_url()?>assets/images/foto/Logo-RSUD-Tebet-square.png" width="35%">
                    </div>
                    ...
                    <div class="tab-pane" id="edit">
                        <form class="form-horizontal" action="<?=base_url(); ?>user/editprofilproses/<?php echo $this->session->userdata("id_user"); ?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" value="<?php echo $this->session->userdata("username"); ?>" name="username">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="myCheck" onclick="myFunction()"> Cek , jika sudah sesuai lalu klik submit & mohon untuk <b style="color: red"><u>login ulang</u></b></a>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" action="<?=base_url(); ?>user/editpassprofproses/<?php echo $this->session->userdata("id_user"); ?>" method="post">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" id="check" onclick="myFunction2()"> Cek , jika sudah sesuai lalu klik submit & mohon untuk <b style="color: red"><u>login ulang</u></b></a>
                                        </label>
                                    </div>
                                </div>
                            </div>
