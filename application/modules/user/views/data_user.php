<div class="box box-info">
    ...
    <div class="box-header">
        <div class="form-group pull-left">
            <a href="<?php base_url();?>user/tambah_user">
        ...
        <table id="example1" class="table table-bordered table-hover dataTable no-footer">
            ...
            <?php $no = 1; foreach ($user as $list): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php base_url();?>user/edit_user/<?php echo $list['id_user']; ?>">
                            <button type="button" class="btn btn-primary btn-flat">Edit</button></a>
                    </td>
                    <td>
                        <a onclick="return confirm('Apakah anda yakin akan menghapus user ini ?')" href="<?=base_url(); ?>user/hapus_user/<?php echo $list['id_user']?>">
